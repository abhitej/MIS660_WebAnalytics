...
if __name__=='__main__':
    records = []
    bad_count = 0
    directory = os.path.normpath(r"C:\Users\Abhitej Kodali\Google Drive\BIA 660 Team Project\Balaji Workspace\Pages")
    ...
    movie_list = pd.DataFrame(records,columns=['Movie','Tomatometer','Audience_score','Audience_average_rating',
                                               ...
                                               'Box_office','Actor_1','Actor_2','Actor_3','Actor_4','Actor_5',
                                               'Actor_6'])
    ...
    #writing to csv file
    movie_list.to_csv("C:/Users/Abhitej Kodali/Google Drive/BIA 660 Team Project/Abhitej Workspace/Full Movie List.csv", index=False)
